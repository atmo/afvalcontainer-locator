...
const TRANSLATIONS = {
  nl: {
    ...
    fractionInzamelpunt: 'Inzamelpunt',
    ...
    printSubtitle:     'Dichtstbijzijnde containers',
    printTagline:      'Gooi je afval niet op straat — de dichtstbijzijnde containers staan op loopafstand.',
    printMinUnit:      'min lopen',
  ...
  en: {
    ...
    fractionPlastic:     'Plastic',
    fractionInzamelpunt: 'Collection point',
    ...
    printTypeLabel:    'Container type:',
    printSubtitle:     'Nearest containers',
    printTagline:      'Don\'t litter — the nearest containers are just a short walk away.',
    printMinUnit:      'min walk',
